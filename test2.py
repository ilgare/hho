...
# suite functions with their origins shifted to (60,60,60...)
...
for i in range(start_fun,end_fun+1):
    ...
    now = datetime.now()
    output_fname=f"output_{num_features}D_{num_trials}_trials_v2_"+ now.strftime("%d-%m-%y_%H:%M:%S")+".txt"

with open(output_fname, 'w') as f:
    
    f.write(f"Using function suite v2 F1--F13")
